    ...
    <div class="about-container">
        <div class="about-hero">
            ...
            <p class="section-lead">
                Мы сопровождаем клиентов на каждом этапе процедуры, объясняем сложные юридические вопросы простым языком и помогаем выбрать законный способ решения долговой ситуации.
            </p>
        </div>
